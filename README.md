...
30. Upper-structure triads
31. Triads across the neck
32. Rhythm, time & self-recording
33. Associative voicing inversions
34. The phrase dictionary
35. How to practice: the multisensory method
...
harmonic & melodic minor modes, and reharmonization; the Javier Sánchez
technique block — upper-structure triads, triads across the neck, and
rhythm/time/self-recording; plus the Chema Vílchez mastery & practice
capstones — associative voicing inversions, the phrase dictionary, and the
multisensory practice method. 35 lessons
